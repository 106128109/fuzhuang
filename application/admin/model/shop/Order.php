...
class Order extends Model
{
    ...
    {
        $value = $value ? $value : (isset($data['shippingtime']) ? $data['shippingtime'] : '');
        return is_numeric($value) ? date("Y-m-d H:i:s", $value) : $value;
    }
    ...
    {
        $value = $value ? $value : (isset($data['receivetime']) ? $data['receivetime'] : '');
        return is_numeric($value) ? date("Y-m-d H:i:s", $value) : $value;
    }
    ...
    {
        $value = $value ? $value : (isset($data['shippingstate']) ? $data['shippingstate'] : '');
